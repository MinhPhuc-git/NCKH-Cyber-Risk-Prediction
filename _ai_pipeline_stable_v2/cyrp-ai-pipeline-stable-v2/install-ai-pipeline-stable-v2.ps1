...
Write-Host "Installing stable AI pipeline check v2..." -ForegroundColor Cyan
& $Python (Join-Path $PatchRoot "scripts\patch_ai_pipeline_stable_v2.py") $ProjectRoot $PatchRoot
...
Write-Host "Stable AI pipeline patch installed." -ForegroundColor Green
Write-Host "Next: build API and user-web, then restart both services." -ForegroundColor Cyan
